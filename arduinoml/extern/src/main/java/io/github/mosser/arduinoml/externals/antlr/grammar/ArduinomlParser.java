...
public class ArduinomlParser extends Parser {
    ...
    public static class RootContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ArduinomlParser.EOF, 0);
        }
    ...
    public static class DeclarationContext extends ParserRuleContext {
        ...
        public TerminalNode IDENTIFIER() {
            return getToken(ArduinomlParser.IDENTIFIER, 0);
        }
    ...
    public static class ExceptionDeclarationContext extends ParserRuleContext {
        ...
        public TerminalNode INTEGER() {
            return getToken(ArduinomlParser.INTEGER, 0);
        }
    ...
    public static class LiteralStringContext extends ParserRuleContext {
        ...
        public TerminalNode STRING() {
            return getToken(ArduinomlParser.STRING, 0);
        }
    ...
    public static class ActionContext extends ParserRuleContext {
        ...
        public TerminalNode SIGNAL() {
            return getToken(ArduinomlParser.SIGNAL, 0);
        }
    ...
    public static class ExceptionTransitionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_exceptionTransition;
        }
    ...
    public static class TemporalTransitionContext extends ParserRuleContext {
        ...
        public TerminalNode DURATION_UNIT() {
            return getToken(ArduinomlParser.DURATION_UNIT, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_temporalTransition;
        }
    ...
    public static class AndConditionContext extends ParserRuleContext {
        ...
        public List<TerminalNode> IDENTIFIER() {
            return getTokens(ArduinomlParser.IDENTIFIER);
        }
    ...
    public static class ConditionTransitionContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_conditionTransition;
        }
